...
import EnviarFacturaWhatsApp from "../../components/EnviarFacturaWhatsApp";
...
export default function Pedido() {
  ...
  const getProductoDataPorLocal = useCallback(
    (producto) => {
  ...
  const handleAgregarProducto = async (producto) => {
    ...
    try {
      ...
      console.log(
        "✅ Producto agregado, nuevo subtotal:",
        pedidoActualizado.subtotal,
      );
      setPedido((prev) => ({
        ...prev,
        ...
        <div className="flex-1 overflow-y-auto p-4">
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-3">
            {productosFiltrados.map((producto) => {
              ...
              const { barrilActivo, vasosDisponibles, stockDisponible } =
                getProductoDataPorLocal(producto);
                    ...
                    <div className="mt-1">
                      <div className="w-full bg-gray-700 rounded-full h-1.5">
                        <div
                          ...
                          style={{
                            width:
                              (vasosDisponibles / producto.capacidad_barril) *
                                100 +
                              "%",
                          }}
                        />
