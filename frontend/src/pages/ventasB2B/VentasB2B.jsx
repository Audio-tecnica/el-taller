...
export default function VentasB2B() {
  ...
  const handleImprimirFactura = async (venta) => {
    try {
      // Cargar detalle completo y abrir modal para imprimir
      const ventaCompleta = await ventasB2BService.obtenerVentaPorId(venta.id);
      setVentaSeleccionada(ventaCompleta);
      setMostrarDetalle(true);
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-gray-300 mt-1">
                  Gestión de facturas corporativas y control de cobros
                </p>
              </div>
            </div>
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        ...
                        {venta.metodo_pago === "Credito" &&
                          venta.fecha_vencimiento && (
                            <div
                              className={`text-xs mt-1 ${venta.dias_mora > 0 ? "text-red-600 font-semibold" : "text-gray-500"}`}
                            >
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex gap-4">
                            ...
                            <div>
                              ...
                              <div
                                className={`text-xs font-semibold ${venta.saldo_pendiente > 0 ? "text-amber-600" : "text-gray-400"}`}
                              >
                          ...
                          <div className="w-full bg-gray-200 rounded-full h-2">
                            <div
                              ...
                              style={{
                                width: `${calcularPorcentajeCobrado(venta.monto_pagado, venta.total)}%`,
                              }}
                            ></div>
                          </div>
                        </div>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex justify-end gap-2">
                          ...
                          {/* Registrar Pago - Solo si no está pagado ni anulado */}
                          {venta.estado_pago !== "Pagado" &&
                            venta.estado_pago !== "Anulado" && (
                              <button
                                onClick={() =>
                                  navigate(`/pagos-b2b?venta_id=${venta.id}`)
                                }
                                className="px-3 py-2 text-sm bg-emerald-50 text-emerald-700 rounded-lg hover:bg-emerald-100 transition-all duration-200 font-medium"
                          ...
                          {venta.estado_pago !== "Anulado" && (
                            <button
                              onClick={() => handleVerDetalle(venta)}
                              className="px-3 py-2 text-sm bg-red-50 text-red-700 rounded-lg hover:bg-red-100 transition-all duration-200 font-medium"
            ...
            {ventas.map((venta, index) => (
              ...
              >
                  ...
                  <div className="bg-gray-50 rounded-lg p-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span
                          className={`text-sm font-bold ${venta.saldo_pendiente > 0 ? "text-amber-600" : "text-gray-400"}`}
                        >
                          {formatearMoneda(venta.saldo_pendiente)}
                        </span>
                      </div>
                ...
                <div className="bg-gray-50 px-4 py-3 border-t flex gap-2">
                  ...
                  {/* 👇 AGREGAR BOTÓN DE IMPRIMIR AQUÍ */}
                  <button
                    onClick={() => handleImprimirFactura(venta)}
                    className="px-3 py-2 text-sm bg-purple-50 text-purple-700 rounded-lg hover:bg-purple-100 transition-all duration-200 font-medium"
                  ...
                  {venta.estado_pago !== "Pagado" &&
                    venta.estado_pago !== "Anulado" && (
                      <button
                        ...
                        className="flex-1 px-3 py-2 text-sm bg-emerald-100 text-emerald-700 rounded-lg hover:bg-emerald-200 transition-all font-medium"
                      >
                        💰 Pagar
                      </button>
                    )}
                  ...
                  {venta.estado_pago !== "Anulado" && (
                    <button
                      onClick={() => handleVerDetalle(venta)}
                      className="px-3 py-2 text-sm bg-red-100 text-red-700 rounded-lg hover:bg-red-200 transition-all font-medium"
                      title="Anular"
                    >
                      🗑️
                    </button>
          ...
          <div className="bg-white rounded-xl shadow-lg p-12 text-center">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M9 12h6m-6 4h12m-5-8v.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"
              />
            </svg>
            ...
            <p className="text-gray-600 mb-6">
              Comienza creando tu primera factura corporativa B2B
            </p>
            <button
              onClick={handleNuevaVenta}
