...
MovimientoInventario.prototype.esEntrada = function() {
  return ['compra', 'devolucion_cliente', 'entrada_transferencia', 'ajuste_positivo'].includes(this.tipo);
};

MovimientoInventario.prototype.esSalida = function() {
  return ['venta', 'devolucion_proveedor', 'salida_transferencia', 'ajuste_negativo', 'merma', 'donacion', 'muestra', 'consumo_interno'].includes(this.tipo);
};
